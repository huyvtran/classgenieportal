    ...
    <div class="row">
        <div class="col-md-10 col-lg-offset-1">
            <div class="panel panel-default">
                <div class="panel-heading">Admin Image Magement <a class="btn btn-success" href="<?php echo url('/imagemanagement/class/create')?>">Add Class Image</a></div>
                        ...
                        foreach($imagemang as $row)
                         ...
                         ?>
                          <tr>
                            ...
                            <td><?php echo $row->role_name?></td>
                            <td><?php echo $row->role_name?></td>
                            <td><?php echo $row->role_name?></td>c
                            <td><?php echo $row->role_name?></td>
                            <td>
                            <span class="col-md-1">

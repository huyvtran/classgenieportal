    ...
    <br />
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form class="form-horizontal" name="classimg_create" id="classimg_create" role="form" method="POST" action="<?php echo e(url('/imagemanagement/class')); ?>" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>

...
<br />
    <div class="col-md-10 col-lg-offset-1">
        <div class="panel panel-default">
            <div class="panel-heading"><span style="font-size:15px;">Add class image &nbsp; &nbsp;</span><a class="btn btn-success search_btn-add" href="<?php echo url('/imagemanagement/class')?>">View List</a></div>
            <div class="panel-body" >

                <?php echo Form::model($edit,['method' => 'PATCH','route'=>['imagemanagement.class.update',$edit->id], 'class'=> 'form-horizontal', 'enctype'=>'multipart/form-data', 'name'=> 'classimg_create', 'id'=>'classimg_create']); ?>

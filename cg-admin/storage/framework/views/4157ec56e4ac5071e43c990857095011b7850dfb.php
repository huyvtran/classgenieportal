                        ...
                        foreach($imagemang as $row)
                         ...
                         ?>
                          <tr>
                            ...
                            <td><img src="../assets/student/<?php echo $row->image?> "width="100px" height="100px"></td>
                           ...
                           <td>
                            ...
                            <?php echo e(Form::open(array('route' => array('imagemanagement.student.destroy', $row->id), 'method' => 'delete'))); ?>

    ...
    <div class="col-md-10 col-lg-offset-1">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form class="form-horizontal" name="classimg_create" id="classimg_create" role="form" method="POST" action="<?php echo e(url('/imagemanagement/skill')); ?>" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>

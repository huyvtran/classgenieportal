    ...
    <div class="row">
        <div class="col-md-10 col-lg-offset-1">
            <div class="panel panel-default">
                <div class="panel-heading">Add Class Image &nbsp;<a class="btn btn-success" href="<?php echo url('/imagemanagement/class')?>">View List</a></div>
                <div class="panel-body">
                    <form class="form-horizontal" name="classimg_create" id="classimg_create" role="form" method="POST" action="<?php echo e(url('/image')); ?>" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
